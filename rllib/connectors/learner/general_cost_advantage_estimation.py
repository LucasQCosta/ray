...
class CostGeneralAdvantageEstimation(ConnectorV2):
    """Learner ConnectorV2 piece computing GAE advantages and value targets for COSTS."""
        ...
        **kwargs,
        ...
        vf_preds = rl_module.foreach_module(
            func=lambda mid, module: (
                module.compute_cost_values(batch[mid]) 
        ...
        for module_id, module_vf_preds in vf_preds.items():
            ...
            module_value_targets = compute_value_targets(
                ...
                rewards=unpad_data_if_necessary(
                    episode_lens,
                    convert_to_numpy(batch[module_id]["costs"]),
                ),
            ...
            batch[module_id]["cost_advantages"] = module_advantages
            batch[module_id]["cost_value_targets"] = module_value_targets
        ...
        tensor_results = self._numpy_to_tensor_connector(
            ...
            batch={
                mid: {
                    "cost_advantages": module_batch["cost_advantages"],
                    "cost_value_targets": module_batch["cost_value_targets"],
                }
